...
/* Smarty version 3.1.31, created on 2019-03-28 10:22:58
  from "C:\xampp7.2\htdocs\erp-equipe\erp\layouts\basic\modules\SSingleOrders\EditViewBlocks.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5c9ca082812667_08697192',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5ba0e2493810b39c192d9c691eee286f68f08b29' => 
    array (
      0 => 'C:\\xampp7.2\\htdocs\\erp-equipe\\erp\\layouts\\basic\\modules\\SSingleOrders\\EditViewBlocks.tpl',
      1 => 1553677434,
      2 => 'file',
    ),
  ),
...
function content_5c9ca082812667_08697192 (Smarty_Internal_Template $_smarty_tpl) {
?>

<style>.colReference{min-width: 290px !important;}.colInteger{min-width: 147px !important;}</style><div class='verticalScroll'><div class='editViewContainer'><form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data"><?php $_smarty_tpl->_assignInScope('WIDTHTYPE', $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'));
...
"/><?php }?><input type="hidden" name="action" value="Save"/><input type="hidden" name="mode" value="updateOrdreNonaff"/><input type="hidden" name="record" id="recordId" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
...
$(document).ready(function() {
   ...
   /* $('#SSingleOrders_editView_fieldName_num_ordre').change(function(){
        var   contract ="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]";
        $('#ref1_display').attr('data-validation-engine',contract);
        alert("test");
