...
class Reglements_ListeBord_View extends Vtiger_Index_View
{
    ...
    public function listeBordNonEnvoyePDF($request)
    {
        ...
        $encaissements=(new \App\Db\Query())->select("acc.raison_sociale,acc.ville,r.date_valeur,r.reg_a_recevoir,r.bordereau,r.type,r.banque,r.montant,r.banque,r.libelle,r.mode_reg")
        ...
        {
            $body.=' <tr>
       <!--rowspan="2"--> <td  style="border: 1px solid black;height: 20px;width: 10px">'.$encaissement["raison_sociale"].'</td>
