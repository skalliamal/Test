...
/* Smarty version 3.1.31, created on 2019-02-13 14:35:06
  from "/var/www/html/ERP/erp-equipe/erp/layouts/basic/modules/Settings/Vtiger/AdvanceFilterCondition.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5c642b1ae61a66_22829736',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f77b9e0e3258c804bc4b957230ba3e38ea8352be' => 
    array (
      0 => '/var/www/html/ERP/erp-equipe/erp/layouts/basic/modules/Settings/Vtiger/AdvanceFilterCondition.tpl',
      1 => 1549880376,
      2 => 'file',
    ),
  ),
...
function content_5c642b1ae61a66_22829736 (Smarty_Internal_Template $_smarty_tpl) {
?>

<?php if (!$_smarty_tpl->tpl_vars['USER_MODEL']->value) {
$_smarty_tpl->_assignInScope('USER_MODEL', Users_Record_Model::getCurrentUserModel());
}?><div class="js-conditions-row form-row" data-js="container | clone"><div class="col-md-4 conditionField"><select class="<?php if (empty($_smarty_tpl->tpl_vars['NOCHOSEN']->value)) {?>chzn-select<?php }?> row form-control m-0" name="columnname" title="<?php echo \App\Language::translate('LBL_CHOOSE_FIELD');?>
...
}?><select class="<?php if (empty($_smarty_tpl->tpl_vars['NOCHOSEN']->value)) {?>chzn-select<?php }?> row form-control m-0" name="comparator" title="<?php echo \App\Language::translate('LBL_COMAPARATOR_TYPE');?>
...
" /></span><div class="col-md-1 btn"><span class="deleteCondition fas fa-trash-alt alignMiddle" title="<?php echo \App\Language::translate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></span></div></div>
<?php }
}
