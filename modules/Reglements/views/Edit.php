...
class Reglements_Edit_View extends Vtiger_Edit_View
{
    ...
    public function process(\App\Request $request)
    {
        ...
        $reg_recu=(new App\Db\Query())->select(['sum(r.montant) as montants'])->from('u_yf_reglements r')->innerJoin('u_yf_finvoice finv', 'finv.finvoiceid = r.finvoiceid and finv.finvoiceid='.$request->getInteger('reference_id'))->one();
