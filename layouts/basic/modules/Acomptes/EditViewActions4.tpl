...
{strip}
	<div class="tpl-EditViewActions c-form__action-panel">
		...
		<button class="btn btn-success" type="submit" name="mode" id="OrderDetails" value="OrderDetails" >
        ...
        {if $REGLEMENT }
			<button class="btn btn-success" type="submit" name="mode" id="OrderDetails" value="Accompte" >
				<span class="fa fa-print"></span>
