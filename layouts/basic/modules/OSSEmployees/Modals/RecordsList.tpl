		...
		<div class="table-responsive">
			...
			<table class="table table-bordered listViewEntriesTable">
				...
				{foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES}
					{if $LISTVIEW_ENTRY->get('direction_affectation') eq 'COMMERCIALE' and
						$LISTVIEW_ENTRY->get('service_affectation') neq 'CLIENTELE' and
						$LISTVIEW_ENTRY->get('service_affectation') neq 'AVANT VENTE' }
