...
class Acomptes_ChangeBord_View extends Vtiger_Index_View
{
    ...
    public function updateBordereauEdicomBanque($request)
    {
        ...
        $query = $mysqli->query("UPDATE u_yf_acomptes a SET bordereau='$bordereauBanque' WHERE a.bordereau = '$bordereauEdicom'");
        $mysqli->close();
