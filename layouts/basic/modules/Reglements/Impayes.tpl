                            ...
                            <div class="actions"><div class="dropright u-remove-dropdown-icon">
                                    ...
                                    <div class="dropdown-menu" aria-label="Actions">
                                        ...
                                        <div class="tpl-ButtonLink c-btn-link btn-group ">
                                            <a role="button" class="btn btn-sm btn-default  js-popover-tooltip  Reglements_listViewBasic_action_LBL_EDIT" data-js="popover" data-placement="top" data-content="Editer" data-target="focus hover" href="index.php?module=Reglements&amp;view=Edit&amp;record={$reglement["reglementsid"]}" data-original-title="" title="" target="_blank">
                                        ...
                                        <div class="tpl-ButtonLink c-btn-link btn-group ">
                                            <a role="button" class="btn btn-sm btn-default  js-popover-tooltip  Reglements_listViewBasic_action_LBL_EDIT" data-js="popover" data-placement="top" data-content="Accompte" data-target="focus hover" href="index.php?module=Reglements&view=Accompte&acccomte={$ORDERDETAIL["num_ordre"]}&reglementid={$reglement["reglementsid"]}" data-original-title="" title="" target="_blank" d="accompte" >
