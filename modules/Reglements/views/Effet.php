...
class Reglements_Effet_View extends Vtiger_Index_View
{
    ...
    public function generer($request)
    {
        ...
        $encaissements=(new \App\Db\Query())->select("inv.number,acc.raison_sociale,acc.ville,r.date_valeur,r.reg_a_recevoir,r.bordereau,r.type,r.banque,r.montant,r.banque,r.libelle,r.banque_edicom")
            ->leftJoin('u_yf_finvoice inv','inv.finvoiceid=r.finvoiceid')
 ...
 <td  style="border: 1px solid black;height: 20px;width: 20px">'.$encaissement["raison_sociale"].'</td>
