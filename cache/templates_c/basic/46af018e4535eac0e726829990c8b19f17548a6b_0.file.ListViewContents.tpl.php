...
/* Smarty version 3.1.31, created on 2019-03-20 07:35:45
  from "/var/www/html/ERP/erp-equipe/erp/layouts/basic/modules/Settings/PDF/ListViewContents.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5c91ed5165f899_97196727',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '46af018e4535eac0e726829990c8b19f17548a6b' => 
    array (
      0 => '/var/www/html/ERP/erp-equipe/erp/layouts/basic/modules/Settings/PDF/ListViewContents.tpl',
      1 => 1549880376,
      2 => 'file',
    ),
  ),
...
function content_5c91ed5165f899_97196727 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" id="noOfEntries"><div class="tpl-Settings-PDF-ListViewContents listViewEntriesDiv u-overflow-scroll-xs-down overflowXAuto mt-2"><?php $_smarty_tpl->_assignInScope('WIDTHTYPE', $_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'));
?><div class="table-responsive"><table class="table table-bordered table-sm listViewEntriesTable"><thead><tr class="listViewHeaders"><?php ob_start();
...
if ($_smarty_tpl->tpl_vars['RECORD_LINK']->value->getLabel() == 'LBL_DELETE_RECORD') {?><button type="button" class="btn btn-sm btn-danger templateDelete"><span class="<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK']->value->getIcon();?>
...
"></span></button><?php } elseif ($_smarty_tpl->tpl_vars['RECORD_LINK']->value->getLabel() == 'LBL_EXPORT_RECORD') {?><a href="<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK_URL']->value;?>
" class="btn btn-primary btn-sm"><span class="<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK']->value->getIcon();?>
 alignMiddle"></span></a><?php } else { ?><a <?php if (stripos($_smarty_tpl->tpl_vars['RECORD_LINK_URL']->value,'javascript:') === 0) {?> onclick="<?php echo substr($_smarty_tpl->tpl_vars['RECORD_LINK_URL']->value,strlen("javascript:"));?>
;if (event.stopPropagation){event.stopPropagation();} else{event.cancelBubble = true;}" <?php } else { ?> href='<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK_URL']->value;?>
' <?php }?> class="<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK']->value->get('class');?>
 btn btn-info btn-sm"><span class="<?php echo $_smarty_tpl->tpl_vars['RECORD_LINK']->value->getIcon();?>
