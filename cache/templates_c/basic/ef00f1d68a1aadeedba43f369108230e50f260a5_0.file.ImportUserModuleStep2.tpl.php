<?php
/* Smarty version 3.1.31, created on 2019-02-27 14:57:30
  from "/var/www/html/ERP/erp-equipe/erp/layouts/basic/modules/Settings/ModuleManager/ImportUserModuleStep2.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5c76a55a1ea3d1_90418100',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ef00f1d68a1aadeedba43f369108230e50f260a5' => 
    array (
      0 => '/var/www/html/ERP/erp-equipe/erp/layouts/basic/modules/Settings/ModuleManager/ImportUserModuleStep2.tpl',
      1 => 1549880376,
      2 => 'file',
    ),
  ),
...
function content_5c76a55a1ea3d1_90418100 (Smarty_Internal_Template $_smarty_tpl) {
?>

<div class="" id="importModules"><div class='widget_header row '><div class="col-12"><?php $_smarty_tpl->_subTemplateRender(\App\Layout::getTemplatePath('BreadCrumbs.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
...
"><input type="hidden" name="mode" value="importUserModuleStep3"><button class="btn btn-warning" onclick="this.form.mode.value = 'updateUserModuleStep3';this.form.submit();"><?php echo \App\Language::translate('BTN_LIBRARY_UPDATE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button><?php }
...
"><input type="hidden" name="module_import_type" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_TYPE']->value;?>
"><input type="hidden" name="module_import_name" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_NAME']->value;?>
"><input type="hidden" name="mode" value="importUserModuleStep3"><span class="text-right"><?php echo \App\Language::translate('LBL_PROCEED_WITH_IMPORT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;&nbsp;<button class="btn btn-success mx-2" type="submit" name="saveButton"<?php if ($_smarty_tpl->tpl_vars['need_license_agreement']->value == 'true') {?> disabled <?php }?>><strong><?php echo \App\Language::translate('LBL_YES');?>
</strong></button><a class="cancelLink btn btn-warning" type="reset" data-dismiss="modal" onclick="javascript:window.history.back();"><?php echo \App\Language::translate('LBL_NO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></span><?php }?></div><?php }?></form></div></div></div></div>
<?php }
}
